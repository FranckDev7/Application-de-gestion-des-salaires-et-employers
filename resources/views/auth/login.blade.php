    ...
    <div class="container full-height">
        <div class="form-container shadow">
            ...
            <form method="post" action="{{ route('handleLogin') }}">
                ...
                <div class="mb-3">
                    <input name="email" type="email" class="form-control" id="email" placeholder="Entrez votre adresse email" required>
                </div>
                <div class="mb-3">
                ...
                <div class="password-recovery">
                    <p class="text-muted">Vous avez oublié votre mot de passe ? <a href="#">Cliquez ici pour le récupérer.</a></p>
                </div>

                <!-- Politique de confidentialité -->
                <div class="text-center">
                    <small class="text-muted">En vous connectant, vous acceptez notre <a href="#">politique de confidentialité</a>.</small>
                </div>
            </form>
        </div>
    </div>
