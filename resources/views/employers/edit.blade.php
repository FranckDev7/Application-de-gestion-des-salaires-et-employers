                ...
                <div class="app-card-body">
                    <form class="settings-form" method="POST" action="{{ route('employer.update', $employer->id) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <input name="nom" value="{{ $employer->nom }}" type="text" class="form-control" id="nom" placeholder="Entrer le nom">
                            <div class="msg_input">
                                @error('nom')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input name="prenom" value="{{ $employer->prenom }}" type="text" class="form-control" id="prenom" placeholder="Entrer le prenom">
                            <div class="msg_input">
                                @error('prenom')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input name ="email" value="{{ $employer->email }}" type="email" class="form-control" id="email" placeholder="Email">
                            <div class="msg_input">
                                @error('email')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input name="contact" value="{{ $employer->contact }}" type="text" class="form-control" id="contact" placeholder="Entrer le contact">
                            <div class="msg_input">
                                @error('contact')
                                    {{ $message }}
                                @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <input name="montant_journalier" value="{{ $employer->montant_journalier }}" type="text" class="form-control" id="montant_journalier" placeholder="Entrer le montant journalier">
                            <div class="msg_input">
